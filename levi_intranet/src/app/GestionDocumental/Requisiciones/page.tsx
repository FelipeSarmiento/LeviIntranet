...
export default function Home() {
    ...
    const dataForms = [
        {
            typeForm: typeFormEnum.Requisiciones,
            information: "Jumbo",
            fileEnable : true,
            dateEnable :true,
            buttonLabel : "Generar Requisición Jumbo",
            centroOperativo: "202"
        },
        {
            typeForm: typeFormEnum.Requisiciones,
            information: "Exito (Bodegas)",
            fileEnable : true,
            dateEnable :true,
            buttonLabel : "Generar Requisición Exito",
            centroOperativo: "200"
        },
        {
            typeForm: typeFormEnum.RequisicionesPedido,
            information: "Exito.com (Pedidos)",
            fileEnable : true,
            dateEnable :true,
            buttonLabel : "Generar Requisición Exito",
            centroOperativo: "200"
    ...
    return (
        <div className="flex flex-col gap-y-5 items-center py-10 w-full flex-1 px-40">
            <h2 className="font-bold text-3xl text-left w-7xl">Requisiciones</h2>
            <div className="w-7xl">
                <Accordion
                    type="single"
                    collapsible
