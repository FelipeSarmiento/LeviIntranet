...
public class ItemDao {
    ...
    public List<ItemsEtiquetas> findItemsById(int id, String listaPrecio, String compania) {
        ...
        LEFT OUTER JOIN t131_mc_items_barras 
